...
echo yes | /opt/android-sdk-linux/tools/android update sdk -a -u -t tools,platform-tools,build-tools-21.1.2,extra-android-support,extra-android-m2repository,android-19
